...
const cityParent = document.querySelector("#south-korea-cities")
const landmarkParent = document.querySelector("#south-korea-landmarks")
const celebrityParent = document.querySelector("#south-korea-celebrities")
