import { getCelebrities } from './vietnamDB.js'
...
export const createCelebrities = () => {
    ...
    let htmlString = `<h2 class="celebrity_title">Famous Vietnamese</h2>
    ...
    for (const celebrity of celebrities) {
        ...
        htmlString += `<li class="celebrity"> 
                            <a class="vietnam-link" href="${celebrity.address}">${celebrity.name}</a> 
                        </li>`
    }
