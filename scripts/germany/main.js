...
const cityParent = document.querySelector("#germany-cities")
const landmarkParent = document.querySelector("#germany-landmarks")
const celebrityParent = document.querySelector("#germany-celebrities")
