import { getCelebrities } from './germanyDB.js'
...
export const createCelebrities = () => {
    ...
    let htmlString = `<h2 class="celebrity_title">Famous Germans</h2>
    ...
    for (const celebrity of celebrities) {
        ...
        htmlString += `<li class="celebrity"> 
                            <a class="germany-link" href="${celebrity.address}">${celebrity.name}</a> 
                        </li>`
    }
